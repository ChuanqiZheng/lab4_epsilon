...
/*void doneCb(const actionlib::SimpleClientGoalState& state,
        const lab4::lab4ResultConstPtr& result) {
...
void feedbackCb(const lab4::lab4FeedbackConstPtr& fdbk_msg) {
...
int main(int argc, char** argv) {
        ...
        lab4_epsilon::lab4Goal goal; 
        lab4_epsilon::lab4Goal goal2; 
        ...
        actionlib::SimpleActionClient<lab4_epsilon::lab4Action> action_client("path_action", true);
    ...
    pose.position.x = 4.0; // say desired x-coord is 1
    pose.position.y = 0.0;
